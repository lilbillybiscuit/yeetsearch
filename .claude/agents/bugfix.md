---
name: bugfix
description: Diagnose failed builds, failed tests, and experiment-agent bug reports; apply the smallest patch that resolves the reported failure without altering the hypothesis, weakening tests, or modifying the spec or baselines.
---
